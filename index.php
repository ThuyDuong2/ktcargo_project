  ...
  <section id="title">
    ...
    <div class="container-fluid">
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #fff">
        <a class="navbar-logo  d-none  d-lg-flex flex-shrink-0" href="index.html" style="color: black">KTcargo</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class=" navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="index.html">
...
<section class="section-name padding-y-sm">
  <div class="col-md-6 px-3 px-md-5 py-5">
        <div class="d-flex align-items-center">
          ...
          <form action=" " class="needs-validation row g-4" method="post" novalidate="">

            <div class="col-12">
              <textarea class="form-control" rows="4" placeholder="Tracking Number" required=""></textarea>
            </div>

            <div class="col-12">
              <button class="btn btn-info btn-shadow" type="submit">Tracking</button>
            </div>
          </form>
        </div>
        </div>
